      ...
      <div class="col-md-12">
        <div class="card border-danger">
          ...
          <div class="card-body">
            ...
            @endphp
            <p>Languages: {{ implode(', ', array_keys($languages)) }}</p>
            <p>Levels: {{ implode(', ', array_keys($levels)) }}</p>
            
            <h6>Direct DB Check (Count: {{ $directDbCheck->count() }}):</h6>
            <ul>
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            <div class="alert alert-info">
              ...
              Anda hanya dapat membuat materi pembelajaran dengan bahasa dan level yang sesuai dengan pengaturan Anda.
            </div>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header bg-primary text-white">
            <h5 class="mb-0">Form Materi Baru</h5>
          </div>
          <div class="card-body">
            <form action="{{ route('teacher.materials.store') }}" method="POST">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  ...
                  <select name="material_type" id="material_type" class="form-select" required>
                    ...
                    <option value="text" {{ old('material_type') == 'text' ? 'selected' : '' }}>Teks</option>
                    <option value="video" {{ old('material_type') == 'video' ? 'selected' : '' }}>Video</option>
                    <option value="audio" {{ old('material_type') == 'audio' ? 'selected' : '' }}>Audio</option>
                    <option value="document" {{ old('material_type') == 'document' ? 'selected' : '' }}>Dokumen</option>
                  </select>
                </div>
              </div>
              ...
              <div class="mb-3 media-url-container" style="display: none;">
                ...
                <input type="url" name="media_url" id="media_url" class="form-control" value="{{ old('media_url') }}">
              ...
              <div class="mb-3 duration-container" style="display: none;">
                ...
                <input type="number" name="duration" id="duration" class="form-control" min="1" value="{{ old('duration', 10) }}">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-4">
                  ...
                  <input type="number" name="order" id="order" class="form-control" min="0" value="{{ old('order', 0) }}">
              ...
              <div class="mb-3 form-check">
                <input type="checkbox" class="form-check-input" name="active" id="active" value="1" {{ old('active', true) ? 'checked' : '' }}>
