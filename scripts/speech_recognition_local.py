...
def recognize_speech_from_file(audio_file, language='id'):
    ...
    try:
        with sr.AudioFile(temp_filename) as source:
            ...
            # For English, try multiple variants and services
            if language == "en":
                ...
                try:
                    ...
                    try:
                        ...
                        # If both fail, try without specifying dialect
                        text = recognizer.recognize_google(audio_data, language="en")
            else:
                # For Indonesian, use the existing approach
                lang_codes = {
                    "id": "id-ID",
                    "en": "en-US",  # default ke US
                    "en-GB": "en-GB",
                    "ja": "ja-JP",
                    "ko": "ko-KR",
                    "ar": "ar-EG",
        ...
        return "Tidak dapat mengenali audio" if language == "id" else "Could not recognize audio"
    except sr.RequestError:
        return "Layanan speech recognition tidak tersedia" if language == "id" else "Speech recognition service unavailable"
